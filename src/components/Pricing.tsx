          ...
          <div className="md:col-span-1 grid md:grid-cols-2 gap-6">
            ...
            <div className="p-8 rounded-2xl border border-white/5 bg-gradient-to-b from-white/[0.02] to-transparent">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-earth-200">Private Telegram Community</h3>
                  <p className="text-xs text-earth-500">Network with fellow participants</p>
                </div>
              </div>
              <p className="text-sm text-earth-400 leading-relaxed">
                Connect with others on the same journey in our private Telegram group. Share wins, 
                ask questions, swap tips, and build local mutual aid networks. Resilience is a team sport.
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl border border-white/5 bg-gradient-to-b from-white/[0.02] to-transparent">
              ...
              <p className="text-sm text-earth-400 leading-relaxed">
                Curated collection of risk assessment templates, emergency plan worksheets, 
                budget trackers, home audit checklists, and recommended reading — everything 
                printable, everything beginner-friendly.
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl border border-white/5 bg-gradient-to-b from-white/[0.02] to-transparent">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-earth-200">Lifetime Access</h3>
                  <p className="text-xs text-earth-500">All future updates included</p>
                </div>
              </div>
              <p className="text-sm text-earth-400 leading-relaxed">
                One payment. No subscriptions. No recurring fees. You get the full system as it is 
                today, plus every update we roll out — new modules, improved prompts, additional 
                AI agents. The system grows, your access doesn't expire.
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl border border-white/5 bg-gradient-to-b from-white/[0.02] to-transparent">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-earth-200">Afterpay Payments</h3>
                  <p className="text-xs text-earth-500">Split into 4 interest-free payments</p>
                </div>
              </div>
              <p className="text-sm text-earth-400 leading-relaxed">
                Don't let upfront cost stop you. Pay just a quarter now and the rest over 6 weeks 
                with Afterpay. Zero interest, zero fees if you pay on time — because preparedness 
                shouldn't be locked behind a full-price paywall.
              </p>
            </div>
          </div>
        </div>
