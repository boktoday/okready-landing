    ...
    <section id="teens-workshop" className="py-24 md:py-32">
      <div className="max-w-[1400px] mx-auto px-6">
        <div className="max-w-[65ch] mb-12">
          <div className="text-xs font-semibold tracking-[0.2em] text-cyan-400 uppercase mb-4">
            School Holiday Program
          </div>
          <h2 className="text-3xl md:text-5xl font-bold tracking-tighter mb-6">
            <span className="text-earth-100">OK Ready</span>{' '}
            <span className="gradient-text-cyan">Workshop for Teens</span>
          </h2>
          <p className="text-lg text-earth-400 leading-relaxed">
            A <strong className="text-cyan-300">two-week, hands-on program</strong> during the school holidays.
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          {/* Info card */}
          <div className="p-8 md:p-10 rounded-3xl border border-cyan-500/20 bg-gradient-to-b from-cyan-500/5 to-transparent glow-cyan">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 rounded-full bg-cyan-500/10 border border-cyan-500/20 flex items-center justify-center text-cyan-400 text-lg">
            ...
            <div className="flex items-center gap-2 mb-6 bg-cyan-500/5 rounded-xl px-4 py-2.5 border border-cyan-500/10">
              ...
              <span className="text-xs text-cyan-300 leading-relaxed">Our trainers hold <strong className="text-cyan-200">NDIS</strong> and <strong className="text-cyan-200">Working with Children</strong> checks</span>
            </div>

            <div className="space-y-4 text-sm text-earth-400">
              <div className="flex items-start gap-3">
                <div className="w-5 h-5 rounded-full bg-cyan-500/10 flex items-center justify-center text-cyan-400 text-xs mt-0.5 flex-shrink-0">1</div>
                <div>
              ...
              <div className="flex items-start gap-3">
                <div className="w-5 h-5 rounded-full bg-cyan-500/10 flex items-center justify-center text-cyan-400 text-xs mt-0.5 flex-shrink-0">2</div>
                <div>
              ...
              <div className="flex items-start gap-3">
                <div className="w-5 h-5 rounded-full bg-cyan-500/10 flex items-center justify-center text-cyan-400 text-xs mt-0.5 flex-shrink-0">3</div>
                <div>
                  <span className="text-earth-200 font-medium">Online via Zoom</span>
                  <br />Live, interactive, small group (max 12 teens)
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Details + Price card */}
          <div className="p-8 md:p-10 rounded-3xl border border-cyan-500/20 bg-gradient-to-b from-cyan-500/5 to-transparent glow-cyan h-full flex flex-col">
            ...
            <div className="mt-auto">
              <div className="flex items-baseline gap-2 mb-2">
                <span className="text-3xl font-bold text-cyan-300">$395</span>
              ...
              <button
                ...
                className="w-full py-3 px-6 rounded-xl bg-gradient-to-r from-cyan-500 to-cyan-600 text-earth-950 font-semibold text-sm hover:from-cyan-400 hover:to-cyan-500 transition-all duration-300"
              >
                Register Now
              </button>
            </div>
